...
HD_PWD='G:/project_placemenet/booth_mul/booth_mul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_multiplier.tcl -notrace
